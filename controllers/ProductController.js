...
const index = async (req, res) => {
    try {
        ...
        if (!products) {throw {code: 500, message: 'index category failed'}};
...
const store = async (req, res) => {
    try{
        ...
        // is objectId
        if(!mongoose.Types.ObjectId.isValid(req.body.categoryId)) { throw { code: 500, message: "CategoryId is not valid" }}
